  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 ${
      ...
      <div className="absolute top-6 left-6">
        <span className="text-white font-medium text-2xl tracking-wide" style={{ 
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center gap-2">
                <div className="flex flex-col items-center gap-2 font-medium">
                  ...
                  <span className="sr-only">Sahayata आवाज़AI</span>
                </div>
                <h1 className={`text-xl font-bold ${
                  ...
                  {isSignUp ? 'Welcome to Sahayata आवाज़AI' : 'Welcome to Sahayata आवाज़AI'}
                </h1>
              ...
              <div className="flex flex-col gap-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-2 px-4 rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                    isDarkMode
